...
def _render_skills_snapshot(skills: list[SkillDescriptor]) -> list[str]:
    ...
    lines.extend(
        [
            ...
            "- For public-web questions that require discovering information or sources, choose a matching search skill before `fetch_url`. Use `fetch_url` only for a user-supplied URL or one returned by a prior search.",
