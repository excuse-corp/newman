# Lieflat Charts 完整设计法典

This reference preserves the pre-simplification `SKILL.md` rules so output quality and edge-case behavior can stay unchanged without loading the full law on every routine chart request.
